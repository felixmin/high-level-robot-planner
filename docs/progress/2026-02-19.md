...
Submitted jobs (fill results later):

| Job ID | Experiment name | Source | Validation limit override | Status | Result notes |
|---|---|---|---|---|---|
| 5487496 | `cluster_s2_diag_resubmit_gcs_lim4_s1000_v400_t45` | `gcs` | `limit_batches=4` | pending |  |
| 5487495 | `cluster_s2_match_resubmit_gcs_lim20_s1000_v400_t45` | `gcs` | `limit_batches=20` | pending |  |
| 5487498 | `cluster_s2_match_gcs_nolimit_s1000_v400_t45` | `gcs` | none (uses default training config) | pending |  |
| 5487497 | `cluster_s2_match_auto_nolimit_s1000_v400_t45` | `auto` | none (uses default training config) | pending |  |
