"""LAQ encoder+VQ inference wrapper for Stage-2 code generation."""

from __future__ import annotations

import torch

from laq.models.forward_core import normalize_video_input
...
class LAQEncoderVQInference(torch.nn.Module):
    """
    ...
    def train(self, mode: bool = True) -> "LAQEncoderVQInference":
