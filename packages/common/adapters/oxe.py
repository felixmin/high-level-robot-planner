...
"""
Open X-Embodiment (OXE) adapter v1 for streaming RLDS datasets from GCS.

See oxe_shared.py for the dataset registry, TFDS resolution, and helpers.
See oxe_v2.py for the reimplemented v2 adapter.
"""
...
from common.adapters.oxe_shared import (
    ...
    OXEDatasetConfig,
    OXE_DATASETS,
    _parse_tfds_prepared_dataset_dir,
...
class OXEFramePairDataset(IterableDataset):
    ...
    def _compute_pair_frame_indices(self, offset: int) -> list[int]:
        return compute_pair_frame_indices(
            offset,
...
# get_oxe_dataset_info is now imported from oxe_shared at the top of this file.
