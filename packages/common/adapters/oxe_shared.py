...
OXE_DATASETS = {
    ...
    "asu_table_top_converted_externally_to_rlds": OXEDatasetConfig(
    ...
    "austin_buds_dataset_converted_externally_to_rlds": OXEDatasetConfig(
    ...
    "austin_sailor_dataset_converted_externally_to_rlds": OXEDatasetConfig(
    ...
    "austin_sirius_dataset_converted_externally_to_rlds": OXEDatasetConfig(
        name="austin_sirius_dataset_converted_externally_to_rlds",
        gcs_path="gs://gresearch/robotics/austin_sirius_dataset_converted_externally_to_rlds/0.1.0",
        image_key="image",
        image_shape=(84, 84, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
    ...
    "berkeley_gnm_cory_hall": OXEDatasetConfig(
        name="berkeley_gnm_cory_hall",
        gcs_path="gs://gresearch/robotics/berkeley_gnm_cory_hall/0.1.0",
        image_key="image",
        image_shape=(64, 85, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
    ...
    "berkeley_gnm_recon": OXEDatasetConfig(
        name="berkeley_gnm_recon",
        gcs_path="gs://gresearch/robotics/berkeley_gnm_recon/0.1.0",
        image_key="image",
    ...
    "berkeley_gnm_sac_son": OXEDatasetConfig(
        name="berkeley_gnm_sac_son",
        gcs_path="gs://gresearch/robotics/berkeley_gnm_sac_son/0.1.0",
        image_key="image",
        image_shape=(120, 160, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
    ...
    "berkeley_mvp_converted_externally_to_rlds": OXEDatasetConfig(
        ...
        gcs_path="gs://gresearch/robotics/berkeley_mvp_converted_externally_to_rlds/0.1.0",
        image_key="hand_image",
        image_shape=(480, 640, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
        state_key="pose",
    ...
    "berkeley_rpt_converted_externally_to_rlds": OXEDatasetConfig(
        name="berkeley_rpt_converted_externally_to_rlds",
        gcs_path="gs://gresearch/robotics/berkeley_rpt_converted_externally_to_rlds/0.1.0",
        image_key="hand_image",
        image_shape=(480, 640, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
    ...
    "cmu_franka_exploration_dataset_converted_externally_to_rlds": OXEDatasetConfig(
        name="cmu_franka_exploration_dataset_converted_externally_to_rlds",
        gcs_path="gs://gresearch/robotics/cmu_franka_exploration_dataset_converted_externally_to_rlds/0.1.0",
        image_key="highres_image",
        image_shape=(480, 640, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
        state_key=None,
    ...
    "cmu_play_fusion": OXEDatasetConfig(
        name="cmu_play_fusion",
        gcs_path="gs://gresearch/robotics/cmu_play_fusion/0.1.0",
        image_key="image",
        image_shape=(128, 128, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
    ...
    "cmu_playing_with_food": OXEDatasetConfig(
        name="cmu_playing_with_food",
        gcs_path="gs://gresearch/robotics/cmu_playing_with_food/0.1.0",
        image_key="image",
        image_shape=(480, 640, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
    ...
    "cmu_stretch": OXEDatasetConfig(
        name="cmu_stretch",
        gcs_path="gs://gresearch/robotics/cmu_stretch/0.1.0",
        image_key="image",
        image_shape=(128, 128, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
    ...
    "dlr_edan_shared_control_converted_externally_to_rlds": OXEDatasetConfig(
        name="dlr_edan_shared_control_converted_externally_to_rlds",
        gcs_path="gs://gresearch/robotics/dlr_edan_shared_control_converted_externally_to_rlds/0.1.0",
        image_key="image",
        image_shape=(360, 640, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
    ...
    "dlr_sara_grid_clamp_converted_externally_to_rlds": OXEDatasetConfig(
        name="dlr_sara_grid_clamp_converted_externally_to_rlds",
        gcs_path="gs://gresearch/robotics/dlr_sara_grid_clamp_converted_externally_to_rlds/0.1.0",
        image_key="image",
        image_shape=(480, 640, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
    ...
    "dlr_sara_pour_converted_externally_to_rlds": OXEDatasetConfig(
        ...
        gcs_path="gs://gresearch/robotics/dlr_sara_pour_converted_externally_to_rlds/0.1.0",
        image_key="image",
        image_shape=(480, 640, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
    ...
    "eth_agent_affordances": OXEDatasetConfig(
        name="eth_agent_affordances",
        gcs_path="gs://gresearch/robotics/eth_agent_affordances/0.1.0",
        image_key="image",
        image_shape=(64, 64, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
    ...
    "iamlab_cmu_pickup_insert_converted_externally_to_rlds": OXEDatasetConfig(
    ...
    "imperialcollege_sawyer_wrist_cam": OXEDatasetConfig(
        name="imperialcollege_sawyer_wrist_cam",
        gcs_path="gs://gresearch/robotics/imperialcollege_sawyer_wrist_cam/0.1.0",
        image_key="image",
        image_shape=(64, 64, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
    ...
    "kaist_nonprehensile_converted_externally_to_rlds": OXEDatasetConfig(
    ...
    "nyu_door_opening_surprising_effectiveness": OXEDatasetConfig(
        ...
        gcs_path="gs://gresearch/robotics/nyu_door_opening_surprising_effectiveness/0.1.0",
        image_key="image",
        image_shape=(720, 960, 3),
        instruction_key="natural_language_instruction",
        instruction_in_step=False,
        state_key=None,
        state_dim=0,
    ...
    "nyu_rot_dataset_converted_externally_to_rlds": OXEDatasetConfig(
        name="nyu_rot_dataset_converted_externally_to_rlds",
        gcs_path="gs://gresearch/robotics/nyu_rot_dataset_converted_externally_to_rlds/0.1.0",
        image_key="image",
        image_shape=(84, 84, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
    ...
    "stanford_kuka_multimodal_dataset_converted_externally_to_rlds": OXEDatasetConfig(
        name="stanford_kuka_multimodal_dataset_converted_externally_to_rlds",
        gcs_path="gs://gresearch/robotics/stanford_kuka_multimodal_dataset_converted_externally_to_rlds/0.1.0",
        image_key="image",
        image_shape=(128, 128, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
    ...
    "stanford_mask_vit_converted_externally_to_rlds": OXEDatasetConfig(
        name="stanford_mask_vit_converted_externally_to_rlds",
        gcs_path="gs://gresearch/robotics/stanford_mask_vit_converted_externally_to_rlds/0.1.0",
        image_key="image",
    ...
    "tokyo_u_lsmo_converted_externally_to_rlds": OXEDatasetConfig(
        name="tokyo_u_lsmo_converted_externally_to_rlds",
        gcs_path="gs://gresearch/robotics/tokyo_u_lsmo_converted_externally_to_rlds/0.1.0",
        image_key="image",
        image_shape=(120, 120, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
    ...
    "usc_cloth_sim_converted_externally_to_rlds": OXEDatasetConfig(
        name="usc_cloth_sim_converted_externally_to_rlds",
        gcs_path="gs://gresearch/robotics/usc_cloth_sim_converted_externally_to_rlds/0.1.0",
        image_key="image",
        image_shape=(32, 32, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
    ...
    "utokyo_pr2_opening_fridge_converted_externally_to_rlds": OXEDatasetConfig(
        name="utokyo_pr2_opening_fridge_converted_externally_to_rlds",
        gcs_path="gs://gresearch/robotics/utokyo_pr2_opening_fridge_converted_externally_to_rlds/0.1.0",
        image_key="image",
        image_shape=(128, 128, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
    ...
    "utokyo_pr2_tabletop_manipulation_converted_externally_to_rlds": OXEDatasetConfig(
        name="utokyo_pr2_tabletop_manipulation_converted_externally_to_rlds",
        gcs_path="gs://gresearch/robotics/utokyo_pr2_tabletop_manipulation_converted_externally_to_rlds/0.1.0",
        image_key="image",
        image_shape=(128, 128, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
    ...
    "utokyo_saytap_converted_externally_to_rlds": OXEDatasetConfig(
        name="utokyo_saytap_converted_externally_to_rlds",
        gcs_path="gs://gresearch/robotics/utokyo_saytap_converted_externally_to_rlds/0.1.0",
        image_key="image",
        image_shape=(64, 64, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
    ...
    "utokyo_xarm_bimanual_converted_externally_to_rlds": OXEDatasetConfig(
        name="utokyo_xarm_bimanual_converted_externally_to_rlds",
        gcs_path="gs://gresearch/robotics/utokyo_xarm_bimanual_converted_externally_to_rlds/0.1.0",
        image_key="image",
        image_shape=(256, 256, 3),
        instruction_key="language_instruction",
        instruction_in_step=True,
